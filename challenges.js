challenges = {
    ...
    "Blair Witch": [
        ...
        "When a player is killed you must enter every room on the map calling out the dead persons name until the body is found. (best played on smaller maps)"
    ],
    ...
    "Dommy Mommy": [
        ...
        "All players can only do things that the dom tells them to",
        "Permission must be given to do anything and everything"
    ],
    "The Bitch": [
        "The special player is the bitch",
