challenges = {
    ...
    "Stubborn Bitches ”Anti vax life hax”": [
    ...
    "The Offering": [
        "Once the room has been found one person must remain in the room for the remainder of the game",
        "Or until the ghost has been figured out",
        "The remaining players must remain outside the room until the person inside dies or gets all the evidence"
    ],
    ...
    "Trust Exercise (Hard)": [
        ...
        "No lights and no flashlights (One UV flashlight permitted).",
    ...
    "Lights Out": [
        ...
        "No house lights or flashlights.",
        "One UV flashlight is permitted."
    ],
    "Anti Vax": [
    ...
    "Women's Jeans": [
        ...
        "This means you may not have space for a flashlight."
    ],
    "Budget Cuts": [
    ...
    "Super Smudge Bros": [
        "All players enter carrying a thermometer/emf, a lighter, and a smudge stick.",
    ...
    "Blair Witch": [
        ...
        "When a player is killed you must enter every room on the map calling out the ghosts name until the body is found. (best played on smaller maps)"
    ],
    ...
    "Freeze!": [
        "During a hunt, players may not leave the room they are in",
        "No exceptions."
    ],
    "Two Minute Madness": [
    ...
    "The Dark One": [
        ...
        "Upon seeing the dark one you can only turn your flashlight back on once you've left the building",
    ...
    "That Sinking Feeling": [
        ...
        "Players must only carry a flashlight until this is done.",
        "Upon finishing, all sinks must be turned off"
    ],
    "Prop Hunt": [
    ...
    "Enemy Of My Enemy": [
        ...
        "BUT, during a hunt they aren't allowed to hide, why would they the ghost is their friend?",
    ...
    "The Ghost": [
        ...
        "They can talk if a player is holding a spirit box",
    ...
    "Red Light Green Light": [
        "One person is the special player",
        "They can say 'Red light' and everyone must completely stop moving",
        "Players can only move when the special player says 'Green Light'",
        "This applies to the special player as well",
        "Players caught breaking this rule should be sacrificed to the ghost"
    ]
}